    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-alma-lilac-50 via-white to-alma-lilac-100">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {/* Info Card */}
                <Card className="border-0 shadow-lg mb-6 bg-alma-lilac-50">
                    <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-alma-blue-100 flex items-center justify-center">
                                <DollarSign className="w-5 h-5 text-alma-blue-900" />
                            </div>
                            <div>
                                <p className="font-medium text-alma-blue-900">Split de Pagamento</p>
                                <p className="text-sm text-alma-blue-900/60">
                                    Você recebe <strong>80%</strong> do valor da consulta.
                                    <strong> 1%</strong> é doado automaticamente via Meraki Social.
                                </p>
                            </div>
                        </div>
                    </CardContent>
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="font-medium text-alma-blue-900">
                                                        {transaction.patients.profiles.full_name}
                                                    </p>
